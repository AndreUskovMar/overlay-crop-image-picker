...
const ImageCropOverlay = () => {
    ...
    const { fixedAspectRatio, minimumCropDimensions, isCircleOverlayShape } = useContext(EditorContext);
        ...
        <PanGestureHandler onGestureEvent={onOverlayMove} onHandlerStateChange={(e) => onHandlerStateChange(e)}>
          <Animated.View style={[
            styles.overlay,
            {
                ...
                borderRadius: isCircleOverlayShape ? cropSize.width / 2 : 0,
            },
            animatedCropSize,
            {
                transform: [
            ...
            {!isCircleOverlayShape && horizontalSections.map((horizontalSection) => {
                return (
